...
public class RightMachineGun : MonoBehaviour
{
    public LeftMachineGun l_mashinegun;
    public TextMeshProUGUI text;
    public InputActionReference rightShootRifle; // 이 스크립트 인스턴스에 할당된 손의 입력 매핑
    ...
    private float machineGunDistance = 500f;
    ...
    public void Reroad()
    {
        if (GameManager.Instance.augmentLevels[3] >= 3)
        {
            return;
        }
        ...
        l_mashinegun.text.text = l_mashinegun.currentBullets.ToString() + "/" + GameManager.Instance.machinegunTotal.ToString();
    }
